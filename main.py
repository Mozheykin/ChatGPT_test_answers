...
def init_press_v():
    ...
    if img is not None:
        ...
        if not positions_answers:
            raise Exception('Not parse positions answers')
        ...
        if answers is None:
            raise Exception('get_answers return None')
        ...
        if response is None:
            raise Exception('get_response return None')
        if answer_chatgpt is None:
            raise Exception('get_answer return None')
